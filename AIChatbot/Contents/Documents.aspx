<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/ChatBotGskAdm.Master" AutoEventWireup="true" CodeBehind="Documents.aspx.cs" Inherits="AQuest.ChatBotGsk.PigeonCms.pgn_content.Contents.Documents" %>
       ...
       <div class="panel panel-red" style="width:100%;height:100%">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-right">
                   <a class="btn btn-success" href="DocumentDetail.aspx"><i class="fa fa-pencil"></i> Insert</a>
                 </div></div>
                                ...
                                <ItemTemplate>
                                   <tr class="gradeA odd" role="row">
                                       ...
                                       <td><%#Eval("Device") %></td>
                                        <td><%#Eval("Typology") %></td>
                                       <td><%#Eval("Enabled") %></td>
                                       <td class='center'><a class='btn btn-primary' href='DocumentDetail.aspx?Id=<%#Eval("IdDocument") %>'><i class='fa fa-edit'></i> Update</a>&nbsp&nbsp&nbsp<a class='btn btn-danger' href='javascript:ShowDelForm(<%#Eval("IdDocument") %>);'><i class='fa fa-times'></i> Delete</a></td>
