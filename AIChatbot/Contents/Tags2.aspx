<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/ChatBotGskAdm.Master" AutoEventWireup="true" CodeBehind="Tags2.aspx.cs" Inherits="AQuest.ChatBotGsk.PigeonCms.pgn_content.Contents.Tags2" %>
  ...
  <a class="various" data-fancybox-type="iframe" href="/Contents/DeleteConfirm.aspx">Iframe</a>--%>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-right">
                   <a class="btn btn-success" href="TagDetail.aspx"><i class="fa fa-pencil"></i> Insert</a>
                 </div></div>
                            <br />
