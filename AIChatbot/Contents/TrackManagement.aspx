...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
      #dataTables-TrackManagement .form-control {
            font-size:12px;
        }
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                           ...
                           <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                    <HeaderTemplate>
                                     <table width="100%" style="font-size:12px" class="table table-striped table-bordered table-hover" id="dataTables-TrackManagement">
                                    <thead>
                                    <tr>
                                        ...
                                        <th style="width: 300px">Description</th>
                                         <th style="width: 300px">Description 2</th>
                                         <th style="width: 170px">Event</th>
                                         <th style="width: 170px">House</th>
                                         <th style="width: 170px">Landlord</th>
                                ...
                                <ItemTemplate>
                                   <tr class="gradeA odd" role="row"><td><%#Eval("id") %></td><td><%#Eval("date") %></td><td style="display:none"><%#Eval("bankReportEntryId") %></td><td><span style="color:green"><asp:label ID="LblAmount" runat="server" Text='<%#Eval("amount") %>'></asp:label></span></td><td><%#Eval("description") %></td><td><asp:TextBox runat="server" ID="TxtDescrizione2" Text='<%#Eval("description2") %>' TextMode="MultiLine" Rows="3" class="form-control Desc2" ></asp:TextBox><div style="float:right;padding-top:5px"><asp:HyperLink runat="Server" Style="Padding:1px" MemIdEvt='<%#Eval("id") %>' Text="Upd" class='btn btn-warning' ID="HypLnkUpdDesc2"></asp:HyperLink></div></td><td><asp:DropDownList ID="CboEventi" MemId='<%#Eval("eventTypeId") %>' MemIdEvt='<%#Eval("id") %>' runat="server" class="form-control"></asp:DropDownList></td><td><asp:DropDownList ID="CboCase" MemId='<%#Eval("houseId") %>' MemIdEvt='<%#Eval("id") %>' runat="server" class="form-control"></asp:DropDownList></td><td><asp:DropDownList ID="CboLandlord" MemId='<%#Eval("landlordId") %>' MemIdEvt='<%#Eval("id") %>' runat="server" class="form-control"></asp:DropDownList></td><td><asp:DropDownList ID="CboParty" MemId='<%#Eval("partyId") %>' MemIdEvt='<%#Eval("id") %>' runat="server" class="form-control"></asp:DropDownList></td><td><button type="button" id="BtnChkOk" style="display:none" class="btn btn-success btn-circle"><i class="fa fa-check"></i></button><button type="button" id="BtnChkErr" style="display:none" class="btn btn-danger btn-circle"><i class="fa fa-times"></i></button></td><td><a class='btn btn-danger' style="Padding:1px" href='javascript:ShowDelForm(<%#Eval("id") %>);'><i class='fa fa-times'></i></a></td><td><a class='btn btn-warning' style="Padding:1px" href='Split.aspx?bankReportEntryId=<%#Eval("bankReportEntryId") %>&evtId=<%#Eval("Id") %>'>Split</a><br /><br /><asp:HyperLink runat="Server" Style="Padding:1px" MemIdEvt='<%#Eval("id") %>'  class='btn btn-warning' ID="HypProc"></asp:HyperLink></td></tr>     
                                </ItemTemplate>
                                <AlternatingItemTemplate>
                                     <tr class="gradeA even" role="row"><td><%#Eval("id") %></td><td><%#Eval("date") %></td><td style="display:none"><%#Eval("bankReportEntryId") %></td><td><asp:label ID="LblAmount" runat="server" Text='<%#Eval("amount") %>'></asp:label></td><td><%#Eval("description") %></td><td><asp:TextBox runat="server" ID="TxtDescrizione2" Text='<%#Eval("description2") %>' TextMode="MultiLine" Rows="3" class="form-control"></asp:TextBox><div style="float:right;padding-top:5px"><asp:HyperLink runat="Server" Style="Padding:1px;" MemIdEvt='<%#Eval("id") %>' Text="Upd" class='btn btn-warning' ID="HypLnkUpdDesc2"></asp:HyperLink></div></td><td><asp:DropDownList ID="CboEventi" MemId='<%#Eval("eventTypeId") %>' MemIdEvt='<%#Eval("id") %>' runat="server" class="form-control"></asp:DropDownList></td><td><asp:DropDownList ID="CboCase" MemId='<%#Eval("houseId") %>' MemIdEvt='<%#Eval("id") %>' runat="server" class="form-control"></asp:DropDownList></td><td><asp:DropDownList ID="CboLandlord" MemId='<%#Eval("landlordId") %>' MemIdEvt='<%#Eval("id") %>' runat="server" class="form-control"></asp:DropDownList></td><td><asp:DropDownList ID="CboParty" MemId='<%#Eval("partyId") %>' MemIdEvt='<%#Eval("id") %>' runat="server" class="form-control"></asp:DropDownList></td><td><button type="button"  id="BtnChkOk" style="display:none" class="btn btn-success btn-circle"><i class="fa fa-check"></i></button><button type="button" id="BtnChkErr" style="display:none" class="btn btn-danger btn-circle"><i class="fa fa-times"></i></button></td><td><a class='btn btn-danger' style="Padding:1px" href='javascript:ShowDelForm(<%#Eval("id") %>);'><i class='fa fa-times'></i></a></td><td><a class='btn btn-warning' style="Padding:1px" href='Split.aspx?bankReportEntryId=<%#Eval("bankReportEntryId") %>&evtId=<%#Eval("Id") %>'>Split</a><br /><br /><asp:HyperLink runat="Server" Style="Padding:1px" MemIdEvt='<%#Eval("id") %>'  class='btn btn-warning' ID="HypProc"></asp:HyperLink></td></tr>
                                </AlternatingItemTemplate>
                                <FooterTemplate>
                                   </tbody>
                            </table>
